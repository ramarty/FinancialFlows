...
import delimited "/Users/robmarty/Desktop/USAID/ChiefEconomist/FinancingFlows/BoP/IMF_83_Data_3/Data.csv", clear
...
save  "/Users/robmarty/Desktop/USAID/ChiefEconomist/FinancingFlows/BoP/Data.dta", replace

********************************************************************************
***** Converting All Values to US Dollar
use  "/Users/robmarty/Desktop/USAID/ChiefEconomist/FinancingFlows/BoP/Data.dta", clear
...
save  "/Users/robmarty/Desktop/USAID/ChiefEconomist/FinancingFlows/BoP/Base.dta", replace
...
foreach IFScode in BXG BMG BXS BMS BICXT BIDXT BXITA BMIT BKAA_CD BK_DB BFDA BFDIA BFPXFDA BFPXFDL BFOA BFOLA BFOAA BFOLAA BFPADF BFPLF BOP NX NFI NINV NM {
	...
	qui merge m:m timelabel countrylabel using "/Users/robmarty/Desktop/USAID/ChiefEconomist/FinancingFlows/BoP/Base.dta", nogen
	qui save "/Users/robmarty/Desktop/USAID/ChiefEconomist/FinancingFlows/BoP/Base.dta", replace
}
...
save  "/Users/robmarty/Desktop/USAID/ChiefEconomist/FinancingFlows/BoP/BoP_Data.dta", replace

********************************************************************************
***** Merging BoP dataset with Financial Flow Dataset
use  "/Users/robmarty/Desktop/USAID/ChiefEconomist/FinancingFlows-ORIGINAL/StataOutput/financialflows.dta", clear // NOTE: Linking to Original.
decode ctry, generate(ctrys)
merge 1:1 ctrys year using "/Users/robmarty/Desktop/USAID/ChiefEconomist/FinancingFlows/BoP/BoP_Data.dta"
save "/Users/robmarty/Desktop/USAID/ChiefEconomist/FinancingFlows/BoP/BoP_Data_IFSAvailability.dta", replace

********************************************************************************
***** LIC and Only Dev and Transition ***
use "/Users/robmarty/Desktop/USAID/ChiefEconomist/FinancingFlows/BoP/BoP_Data_IFSAvailability.dta", clear
...
graph export "/Users/robmarty/Desktop/USAID/ChiefEconomist/FinancingFlows/StataFigures/GrossFinancialTrade.pdf", replace
...
legend(label(1 "Goods") label(2 "Goods and Services") label(3 "Goods, Services and Income") label(4 "Current Account")) ///
legend(off) ///
plotregion(style(none)) ///
graphregion(color(white)) ///
...
m(p p p p) ///
yti(Percent of GDP) ///
ti("{bf:LICs}", size(medsmall)) legend(label(1 "Goods") label(2 "Goods and Services") label(3 "Goods, Services and Income") label(4 "Current Account")) ///
legend(on) ///
plotregion(style(none)) ///
graphregion(color(white)) ///
...
plotregion(style(none)) ///
graphregion(color(white)) ///
ti("{bf:Gross Trade Flows}", size(medium)) ///
note("Values are averaged across countries") 

graph display, ysize(5) xsize(4)

graph export "/Users/robmarty/Desktop/USAID/ChiefEconomist/FinancingFlows/StataFigures/GrossTrade.pdf", replace
...
graph export "/Users/robmarty/Desktop/USAID/ChiefEconomist/FinancingFlows/StataFigures/GrossFinancialTRatioTrade.pdf", replace
